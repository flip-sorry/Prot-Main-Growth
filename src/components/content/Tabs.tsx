...
export default function Tabs({ tabs, onTabClick, className = '' }: TabsProps) {
  return (
    <div className={`bg-white border-b-2 border-background flex items-end w-full max-w-full min-w-0 relative pl-4 md:pl-6 ${className}`}>
      ...
      <div className="flex h-[50px] md:h-[62px] items-center justify-end w-[120px] py-2 pl-2 pr-0 md:py-3 md:pl-3 md:pr-0 rounded-tr-lg shrink-0 flex-shrink-0 bg-white absolute right-4 md:right-6 top-0 z-10">
